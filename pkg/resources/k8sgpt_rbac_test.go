...
func Test_dynamicRBACEnabled_Unset(t *testing.T) {
	...
	assert.False(t, dynamicRBACEnabled(), "should default to false when env var is unset")
}
...
func Test_dynamicRBACEnabled_InvalidValue(t *testing.T) {
	...
	assert.False(t, dynamicRBACEnabled(), "unparseable value should default to false")
}

func Test_dynamicRBACEnabled_EmptyString(t *testing.T) {
	t.Setenv(dynamicRBACEnvVar, "")
	assert.False(t, dynamicRBACEnabled(), "empty string should default to false")
}
...
// ---------------------------------------------------------------------------
// Sync – dynamic RBAC disabled (default)
// ---------------------------------------------------------------------------

func Test_Sync_DynamicRBACDisabled_SkipsRBACResources(t *testing.T) {
	os.Unsetenv(dynamicRBACEnvVar) // ensure unset → defaults to false
