...
func (in *K8sGPTStatus) DeepCopyInto(out *K8sGPTStatus) {
	*out = *in
	if in.LastAnalysisErrorTime != nil {
		in, out := &in.LastAnalysisErrorTime, &out.LastAnalysisErrorTime
		*out = (*in).DeepCopy()
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResultTargetReference) DeepCopyInto(out *ResultTargetReference) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResultTargetReference.
func (in *ResultTargetReference) DeepCopy() *ResultTargetReference {
	if in == nil {
		return nil
	}
	out := new(ResultTargetReference)
